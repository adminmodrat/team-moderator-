...
TELEGRAM_TOKEN = os.environ.get("TELEGRAM_TOKEN", "8576842011:AAEw80HhI1H7DojSHwSEQpE82zXJPodW4")
...
async def send_telegram(text: str):
    url = f"https://api.telegram.org/bot{-1001003994052181}/sendMessage"
    payload = {
